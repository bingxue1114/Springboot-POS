...
public class Order
{
    ...
    private String label_table_num;
    ...
    public String getLabel_table_num() {
        return label_table_num;
    }

    public void setLabel_table_num(String label_table_num) {
        this.label_table_num = label_table_num;
    }
